/* PublicaMundi Mapping API version 0.1.0 2015-10-26 */
...
;(function (window, PublicaMundi) {
    ...
    PublicaMundi.Map = PublicaMundi.Class({
        initialize: function (options) {
            ...
            this._layerHighlight = null;
            this._featureHighlight = null;
    ...
    PublicaMundi.Parser = PublicaMundi.Class({
        ...
        parseWMS: function(responseXML) {
            ...
            for (var idx in candidates){
                ...
                candidate["CRS"] = candidate["CRS"]["_text"];

                var bbox = candidate["EX_GeographicBoundingBox"];
                var bboxfloat = null;
                if (bbox){
